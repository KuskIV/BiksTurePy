...
def iterate_trough_imgs(model_object_list:list,image_dataset:list,lable_dataset:list,label_dict:dict)->tuple:
    right = 0
    wrong = 0
...
def update_values(key:int,label_dict:dict,prt:bool):
    class_name = str(key)
