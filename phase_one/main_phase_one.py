...
def ex_one(test_path:str, train_path:str, lazy_split:int=1, epoch_limit:int=100, folder_extension:str="experiment_one", model_paths:list=None, data_to_test_on=1)->None:
    ...
    """
    run_experiment_one(lazy_split, train_path, test_path, get_satina_gains_model_object_list, epochs_end=epoch_limit, folder_extension=folder_extension, model_paths=model_paths, data_to_test_on=data_to_test_on)

def ex_two_eval_norm(test_path:str, train_path:str, lazy_split:int=1, epoch_limit:int=100, folder_extension:str="experiment_two_eval_norm", data_to_test_on=1):
    ...
    """
    run_experiment_one(lazy_split, train_path, test_path, get_satina_gains_model_norm_object_list, epochs_end=epoch_limit, folder_extension=folder_extension, data_to_test_on=data_to_test_on)
