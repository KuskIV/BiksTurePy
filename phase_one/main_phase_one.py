...
if __name__ == "__main__":
    ...
    h5_train = h5_object(train_path, training_split=dataset_split)
    ...
    for e in range(3, 10):
        ...
        for i in range(len(loaded_models)):
            ...
            for j in classes:
                ...
                prediction = make_prediction(loaded_models[i], image_dataset[j].copy(), (image_sizes[i][0], image_sizes[i][1], 3))
