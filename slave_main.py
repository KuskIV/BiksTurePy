...
def create_dirs(base_ex, base_result, base_big_lobster, base_big_lobster_level, index):
...
def run_biksture(index, data_to_test_on, run_base_experiments=True, run_ideal_experiments=True, 
    ...
    create_dirs(base_ex, base_result, base_big_lobster, base_big_lobster_level, index)
