...
from global_paths import get_h5_path, get_h5_test, get_h5_train, get_data_set_path, get_training_set_path,get_test_set_path
...
if __name__ == "__main__":
    ...
    test_data_path = get_test_set_path()
